...
@Autonomous(name = "Jewel Test 2 (split)", group = "test")
@Disabled
public class NewJewels2 extends OpMode {
    ...
    public void init() {
        ...
        visuals.getPreview().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { visuals.takeSaveSplitPic("new_jewel_test_2.png"); picID++; }
        });
