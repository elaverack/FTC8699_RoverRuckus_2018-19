...
@Autonomous(name = "Crypto Realtime Red", group = "test")
//@Disabled
public class CryptoRTRed extends OpMode {
    ...
    @Override
    public void loop() {
        if (((int)(runtime.seconds()%3) == 0)) numDividers = visuals.previewCryptobox(Enums.Color.RED).size();
