...
@Autonomous(name = "QUAL_BSP_AUTO", group = "Iterative Opmode")
//@Disabled
public class BSP_AUTO extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot = new Mecanlift(this, Mecanlift.Color.BLUE_PARK, Mecanlift.Position.SIDE);
