...
@Autonomous(name = "QUAL2_R_AUTO", group = "Linear Opmode")
@Disabled
public class qual2_r_auto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (robot.c.blue() > robot.c.red()) {
            ...
            robot.stop_drive();
        } else if (robot.c.red() > robot.c.blue()) {
