...
@Autonomous(name = "QUAL_RSP_AUTO", group = "Iterative Opmode")
//@Disabled
public class RSP_AUTO extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot = new Mecanlift(this, Mecanlift.Color.RED_PARK, Mecanlift.Position.SIDE);
